...
def set_all_rules(world: ZooTycoonWorld) -> None:
...
def set_all_entrance_rules(world: ZooTycoonWorld) -> None:
...
def set_all_location_rules(world: ZooTycoonWorld) -> None:
...
def set_completion_condition(world: ZooTycoonWorld) -> None:
