...
Scorpions of Africa (Progressive Insect House)
Venomous Spiders (Progressive Insect House)
Reptiles of the Rainforest (Progressive Reptile House)
Deadly Snakes of the World (Progressive Reptile House)
Endangered Primates of the World (Progressive Primate House)
Primates of South East Asia (Progressive Primate House)
Lemurs of Madagascar (Progressive Primate House)
Birds of the Tropical Rainforest (Progressive Aviary)
Birds of Africa (Progressive Aviary)
Raptors of the World (Progressive Aviary)
Triadobatrachus of the Triassic (Progressive Lepospondyl House)
Karaurus of te Jurassic (Progressive Lepospondyl House)
Diplocaulus of the Permian (Progressive Lepospondyl House)
Pterodactyls of the Late Jurassic (Progressive Pterosaur House)
Ramphorhynchus of the Late Jurassic (Progressive Pterosaur House)
Dimorphodon of the Early Jurassic (Progressive Pterosaur House)
Crayfish of the Mississippi (Progressive Crustacean House)
Horseshoe Crabs of Delaware Bay (Progressive Crustacean House)
Spider Crabs of the North Atlantic (Progressive Crustacean House)
Clownfish of the Pacific (Progressive Tropical Aquarium)
Angelfish of the Amazon (Progressive Tropical Aquarium)
Blue Tang of Bermuda (Progressive Tropical Aquarium)
Dawn Bats of Southeast Asia (Progressive Nocturnal House)
Giant Fruit Bats of Southeast Asia (Progressive Nocturnal House)
Sulawesi Flying Foxes of Southeast Asia (Progressive Nocturnal House)
Small Restroom (Progressive Restroom)
Family Restroom (Progressive Restroom)
Aquatic Restroom (Progressive Restroom)
Fancy Restroom (Progressive Restroom)
Snack Machine (Progressive Food Stand)
Ice Cream Stand (Progressive Food Stand)
Hot Dog Stand (Progressive Food Stand)
Burger Stand (Progressive Food Stand)
Restaurant (Progressive Restaurant)
Lobby's Restaurant (Progressive Restaurant)
Mammoth Cones (Progressive Dino Food Stand)
Bronto Burger (Progressive Dino Food Stand)
Polly's Popcorn (Progressive Marine Food Stand)
Crushed Ice (Progressive Marine Food Stand)
Frozen Yogurt (Progressive Marine Food Stand)
Sea Dawgs (Progressive Marine Food Stand)
Kneemo's Subs (Progressive Marine Food Stand)
Animal Theater
Carousel
Compost Building
Elephant Ride
Gift Stand (Progressive Gift Shop)
Gift Shop (Progressive Gift Shop)
Dinosaur Gift Stand (Progressive Dino Gift Shop)
Dinosaur Gift Shop (Progressive Dino Gift Shop)
Aquatic Gift Stand (Progressive Aquatic Gift Shop)
Aquatic Gift Shop (Progressive Aquatic Gift Shop)
Atlantean Gift Shop (Progressive Aquatic Gift Shop)
Japanese Garden
Petting Zoo
Bouncy Ride
Dino Slide
...
Shark Tunnel
Swim Shack
Grandstand (Progressive Grandstand)
Fancy Grandstand (Progressive Grandstand)

FENCING:

Stick Pole Fence (Progressive Fence)
Wood Slat Fence (Progressive Fence)
Rock Fence (Progressive Fence)
Chain Link Fence (Progressive Fence) (Also unlocks Post and Rail Fences)
Concrete Fences (Progressive Fence)
Iron Rail Fences (Progressive Fence) (Also unlocks Concrete and Iron Bar Fences)
Plexiglass Fences (Progressive Fence)
Reinforced Concrete Fences (Progressive Fence)
Electrified Fences (Progressive Fence)

Black Bar and Glass Tank (Progressive Tank)
Concrete Edge and Glass Tank (Progressive Tank)
Solid Concrete Tank (Progressive Tank)
Atlantean Tank (Progressive Tank)

PATHS:

Dirt/Sand Paths (Progressive Paths)
Asphalt/Concrete Paths (Progressive Paths)
Cobblestone/Red Brick Paths (Progressive Paths)
Boardwalk/Atlantean Paths (Progressive Paths)
Yellow Brick Paths (Progressive Paths)

FOLIAGE:
Small Flowerbeds (Progressive Flowerbeds)
Large Flowerbeds (Progressive Flowerbeds)
Desert Flowers
Topiaries
Basic Trees (Progressive Tree) (Wild Olive, Pacific Dogwood)
Japanese Maple Tree (Progressive Tree)
Cherry Tree (Progressive Tree)
Christmas Tree (Progressive Tree)

SCENERY

Fountain (Progressive Fountain)
Elephant Fountain (Progressive Fountain)
Turtle Fountain (Progressive Fountain)
Ancient Fountains (Progressive Fountain)
    Giant Tortoise
    Wooly Mammoth
Marine Fountains (Progressive Fountain)
    Dolphin
    Jumping
    Wishing
...
Elephant and Lion Statues (Progressive Statues)
Bighorn Statue (Progressive Statues)
Sphinx Statue (Progressive Statues)
Marine Statues (Progressive Statues)
    Deep Sea Diver
    Dolphin
    Mermaid
    Orca
...
Progressive Wall Scenery 1
    Post and Rope Fence
    Low Hedge Fence
    Buoy Rope Fence
Progressive Wall Scenery 2
    Cast-Iron Fence
    Low Sand Wall
    Picket Fence
    White Fence 
Progressive Wall Scenery 3
    Brick Wall
    Atlantean Walls
...
Large Bench
Metal Bench
Picnic Table (Progressive Picnic Table)
Metal Picnic Table (Progressive Picnic Table)
...
TRAPS:
Poo Trap (Poop appears randomly across park)
Trash Trap (Trash left all over ground)
Time Trap (Time slows down)
Riot Trap (Animals get angry?)
"""
...
DEFAULT_ITEM_CLASSIFICATIONS = {
    ...
    "Animal": ItemClassification.progression | ItemClassification.useful,  # Items can have multiple classifications.
...
def get_random_filler_item_name(world: ZooTycoonWorld) -> str:
...
def create_item_with_correct_classification(world: ZooTycoonWorld, name: str) -> ZooTycoonItem:
    ...
    return ZooTycoonItem(name, classification, ITEM_NAME_TO_ID[name], world.player)


# With those two helper functions defined, let's now get to actually creating and submitting our itempool.
def create_all_items(world: ZooTycoonWorld) -> None:
